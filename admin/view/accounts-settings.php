        ...
        <form id="form" action="javascript:;" method="post">
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="input-group m-b-30">
                  <label>Ustd Trc20 Wallet Code</label>
                  <input type="text" class="form-control" name="bitcoin_wallet" value="<?=$res['bitcoin_wallet']?>">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="input-group m-b-30">
                  <label>Ustd Trc20 QR resmi</label>
                  <input type="text" class="form-control" name="bitcoin_img" value="<?=$res['bitcoin_img']?>">
                </div>
              </div>
                  <div class="col-sm-6">
                <div class="input-group m-b-30">
                  <label>Eth Trc20 Wallet Code</label>
                  <input type="text" class="form-control" name="bitcoin_wallet3" value="<?=$res['bitcoin_wallet3']?>">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="input-group m-b-30">
                  <label>Eth Trc20 QR resmi</label>
                  <input type="text" class="form-control" name="bitcoin_img3" value="<?=$res['bitcoin_img3']?>">
                </div>
              </div>
                  <div class="col-sm-6">
                <div class="input-group m-b-30">
                  <label>Bitcoin Wallet Code</label>
                  <input type="text" class="form-control" name="bitcoin_wallet2" value="<?=$res['bitcoin_wallet2']?>">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="input-group m-b-30">
                  <label>Bitcoin QR resmi</label>
                  <input type="text" class="form-control" name="bitcoin_img2" value="<?=$res['bitcoin_img2']?>">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="input-group m-b-30">
              ...
              <div class="col-sm-6">
                <div class="input-group m-b-30">
                  ...
                  <input type="text" class="form-control" name="payfix_number" value="<?=$res['payfix_number']?>">
                      ...
                      <div class="col-sm-6">
                  <div class="input-group m-b-30">
                  <label>MEFETE Hesap Sahibi</label>
                  <input type="text" class="form-control" name="mefete_holder" value="<?=$res['mefete_holder']?>">
                </div>
              </div>
              <div class="col-sm-6">
                  <div class="input-group m-b-30">
                  <label>MEFETE Cüzdan Numarası</label>
                  <input type="text" class="form-control" name="mefete_number" value="<?=$res['mefete_number']?>">
                </div>
              </div>
              
                       <div class="col-sm-6">
                <div class="input-group">
                  <label>Parazula Hesap Sahibi</label>
                  <input type="text" class="form-control" name="parazula_holder" value="<?=$res['parazula_holder']?>">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="input-group">
                  <label>Parazula Cüzdan Numarası</label>
                  <input type="text" class="form-control" name="parazula_number" value="<?=$res['parazula_number']?>">
                </div>
              </div>
            </div>
          </div>
