<div class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="dropdown active">
      ...
      <li><a href="payments?type=paykasa">MEFETE<span key="paykasa" class="counter text-white bg-red-gradient"><?=$db->query("SELECT count(id) as num from payments where status = 0 && type = 'paykasa'")->fetch_assoc()['num']?></span></a></li>
      
       <li><a href="payments?type=parazula">Parazula<span key="parazula" class="counter text-white bg-red-gradient"><?=$db->query("SELECT count(id) as num from payments where status = 0 && type = 'parazula'")->fetch_assoc()['num']?></span></a></li>
       
       
        <li><a href="payments?type=bitcoin">Tether<span key="bitcoin" class="counter text-white bg-red-gradient"><?=$db->query("SELECT count(id) as num from payments where status = 0 && type = 'bitcoin'")->fetch_assoc()['num']?></span></a></li>

        <li><a href="payments?type=bitcoin2">Bitcoin<span key="bitcoin2" class="counter text-white bg-red-gradient"><?=$db->query("SELECT count(id) as num from payments where status = 0 && type = 'bitcoin2'")->fetch_assoc()['num']?></span></a></li>
           <li><a href="payments?type=bitcoin3">Etherum<span key="bitcoin3" class="counter text-white bg-red-gradient"><?=$db->query("SELECT count(id) as num from payments where status = 0 && type = 'bitcoin3'")->fetch_assoc()['num']?></span></a></li>
